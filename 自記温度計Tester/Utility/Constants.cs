...
namespace 自記温度計Tester
{
    public static class Constants
    {
        ...
        public static readonly string PassDataOyakiMenteFolderPath = @"C:\自記温度計\検査データ\本機保守\合格品データ\";
        public static readonly string FailDataOyakiMenteFolderPath = @"C:\自記温度計\検査データ\本機保守\不良品データ\";
        public static readonly string fileName_RetryLogOyakiMente  = @"C:\自記温度計\検査データ\本機保守\不良品データ\リトライ履歴.txt";

        public static readonly string PassDataKokiMenteFolderPath = @"C:\自記温度計\検査データ\子機保守\合格品データ\";
        public static readonly string FailDataKokiMenteFolderPath = @"C:\自記温度計\検査データ\子機保守\不良品データ\";
        public static readonly string fileName_RetryLogKokiMente  = @"C:\自記温度計\検査データ\子機保守\不良品データ\リトライ履歴.txt";
