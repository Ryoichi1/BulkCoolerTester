...
namespace 自記温度計Tester
{
    ...
    /// Test.xaml の相互作用ロジック
    /// </summary>
    public partial class PrintForMainte
    {
        ...
        private void tbOpecode_TextChanged(object sender, TextChangedEventArgs e)
        {
                ...
                System.Text.RegularExpressions.RegexOptions.ECMAScript))
            {
                ...
                string dataFilePath仮1 = Constants.PassDataMenteAFolderPath + tbOpecode.Text + ".csv";
                string dataFilePath仮2 = Constants.PassDataOyakiMenteFolderPath + tbOpecode.Text + ".csv";
                string dataFilePath仮4 = Constants.PassDataKokiMenteFolderPath + tbOpecode.Text + ".csv";
